	...
	<div id="main" class="container">
		<form action="controller.do" method="post">
			...
			<div class="row">
				<div class="col-md-6">
					<p>
						<!-- <strong>ID<br></strong> --> <input type="hidden" name="id"
							value="${atualizarEmpresa.id}"  />
					</p>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<p>
						<input type="hidden" name="cnpj" value="${atualizarEmpresa.cnpj}" maxlength="14"/>
					</p>
				</div>
			</div>
			<div>
			...
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" name="command" value="AtualizarEmpresa" class="btn btn-default">Enviar</button>
